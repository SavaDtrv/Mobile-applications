...
class BluetoothProcessHandling extends Activity implements View.OnClickListener{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_CANCELED){
            startActivity(new Intent(BluetoothProcessHandling.this, OptionsScreen.class));
